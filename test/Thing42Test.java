...
public class Thing42Test {
    ...
    public void testAddPeer() {
        ...
        assertEquals(true, rgbBlack.getPeersAsCollection().contains(intString1));
    ...
    public void testGetOnePeer() {
        ...
        rgbBlack.addPeer(rgbRed);
        assertEquals(1, rgbBlack.getPeersAsCollection().size());
        Thing42orNull<String,String> onePeer = rgbBlack.getOnePeer("#FF0000"); 
    ...
    public void testGetOnePeerNPExc(){
        ...
        rgbBlack.addPeer(rgbRed);
        assertEquals(1, rgbBlack.getPeersAsCollection().size());        
        Thing42orNull<String,String> anotherPeer = rgbBlack.getOnePeer("#FF000");
    ...
    public void testGetPeersAsCollection_GenericType() {      
        ...
        for(Thing42orNull peer 
                : (HashSet<Thing42orNull>)rgbBlack.getPeersAsCollection("#FF0000")){
